...
const kanbanColumns: { status: TicketStatus; label: string; dotClass: string }[] = [
    { status: "received", label: "Прийнято", dotClass: "bg-muted-foreground" },
    { status: "in-progress", label: "В роботі", dotClass: "bg-glow-blue dot-glow-blue" },
    { status: "ready", label: "Готово", dotClass: "bg-glow-green dot-glow-green" },
            ...
            >
              ...
              <div className="flex items-center justify-between px-1">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-medium text-sm md:text-base text-foreground">{column.label}</h3>
                </div>
