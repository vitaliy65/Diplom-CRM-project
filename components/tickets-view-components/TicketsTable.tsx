...
import { containerVariants } from "../crm/tickets-view";
        ...
        <table className="w-full min-w-[600px]">
          <thead>
            <tr className="border-b border-border/50">
              <th className="px-3 md:px-4 py-2 md:py-3 text-left text-[10px] md:text-xs font-medium text-muted-foreground">
                ID
              </th>
              <th className="px-3 md:px-4 py-2 md:py-3 text-left text-[10px] md:text-xs font-medium text-muted-foreground">
                Клієнт
              ...
              <th className="hidden md:table-cell px-3 md:px-4 py-2 md:py-3 text-left text-[10px] md:text-xs font-medium text-muted-foreground">
                Проблема
              </th>
              <th className="px-3 md:px-4 py-2 md:py-3 text-left text-[10px] md:text-xs font-medium text-muted-foreground">
                Майстер
          ...
          <tbody>
            {tickets.map((ticket, index) => (
              ...
              >
                <td className="px-3 md:px-4 py-2 md:py-3 font-mono text-[10px] md:text-sm text-muted-foreground">
                  {ticket.id}
                </td>
